<template>
    <div>
        <form @submit.prevent="submit" class="contact-form">
            ...
            <div class="form-group required">
                <label>会社名</label>
                <input type="text" class="form-control" v-model="data.company" required>
            </div>
            <div class="form-group required">
                <label>電話番号</label>
                <input type="text" class="form-control" v-model="data.tel" required>
            </div>
            <div class="form-group required">
                <label>HADOのご検討状況をお聞かせください </label><br>
                <template v-for="option,index in ['HADOの導入を検討している','HADOを含め情報収集している段階である']">
<!--                    <input  type="radio" v-model="data.usehado" :value="option" required>{{option}}-->
                    <div class="form-check d-block d-lg-inline-block mr-lg-4">
                        <input class="form-check-input" type="radio" :id="'usehado' + index" :value="option" v-model="data.usehado">
            ...
            <div class="form-group required">
                ...
                <template v-for="option,index in ['HADOを常設コンテンツとして利用したい','HADOをイベントで利用したい（商業施設、地域活性化、テーマパークなど）','HADO法人向けプログラム（社員旅行、懇親会、社員研修、社員総会、周年イベントなど）で利用したい']">
                    <div class="form-check d-block d-lg-inline-block mr-lg-4">
                        <input class="form-check-input" type="radio" :id="'plan' + index" :value="option" v-model="data.plan">
            ...
            <div class="form-group required">
                ...
                <template
                    ...
                    <div class="form-check">
                        <input  type="checkbox" :id="'form-place'+index" v-model="data.place" :value="option" class="form-check-input" required><label :for="'form-place'+index" class="form-check-label">{{option}}</label>
                    </div>
                </template>
            </div>
            ...
            <div class="form-group required">
                ...
                <textarea class="form-control" v-model="data.placedetail" required></textarea>
            </div>
            ...
            <div class="form-group required">
                ...
                <template v-for="option,index in
                    ...
                    'HADO MONSTER BATTLE',
                    'HADO SHOOT']">
<!--                    <input  type="radio" v-model="data.hadotype" :value="option" required>{{option}}-->
                    <div class="form-check d-block d-lg-inline-block mr-lg-4">
                        <input class="form-check-input" type="radio" :id="'hadotype' + index" :value="option" v-model="data.hadotype">
            ...
            <div class="form-group required">
                ...
                <select v-model="data.budget" class="form-control" style="max-width: 270px;">
            ...
            <div class="form-group">
                ...
                <template
                    ...
                    <div class="form-check form-check-inline">
                        <input  type="checkbox" :id="'form-know'+index" v-model="data.whereknow" :value="option" class="form-check-input" ><label :for="'form-know'+index" class="form-check-label">{{option}}</label>
                    </div>
                </template>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" v-model="data.other" style="min-height: 100px;"></textarea>
            </div>
