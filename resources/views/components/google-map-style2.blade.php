<div id="map" class="section">
    ...
    <div class="container-fluid mt-5">
        <div class="row align-items-center">
            <div class="col-12 col-md-6 col-xl-7 col-xxl-7 order-1 order-md-0 mt-5 mt-md-0 p-0 p-md-3">
            ...
            <div class="col-12 col-md-6  col-xl-4 col-xxl-2 offset-xl-1  offset-xxl-3 d-flex justify-content-center col-12 order-0 order-md-1">
